        ...
        if (state is AddTaskSuccess) {
          return StateMsg.success(
            ...
            buttons: [
              ...
              OutlinedButton.icon(icon: Icon(Icons.home), onPressed: ctr.onTapHome, label: Text("Voltar ao início")),
            ],
          );
        }
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          TextButton.icon(
                            ...
                            icon: Icon(state.hasCompleted ? Icons.check_circle : Icons.radio_button_unchecked),
                          ),
                        ],
                      ),
                      if (state.hasAdd)
