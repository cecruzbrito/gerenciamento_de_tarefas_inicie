...
abstract class AddOrUpdateTaskState extends Equatable {
  @override
...
class AddOrUpdateTaskInput extends AddOrUpdateTaskState {
  ...
  @override
  List<Object?> get props => [task, hasCompleted];
...
class AddTaskSuccess extends AddOrUpdateTaskState {
  ...
  @override
  List<Object?> get props => [msg, taskCreated];
}
...
class UpdateTaskSuccess extends AddOrUpdateTaskState {
  ...
  @override
  List<Object?> get props => [msg, taskUpdated];
}
